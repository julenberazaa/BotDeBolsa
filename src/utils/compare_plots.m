function compare_plots(results, outputPath)
% COMPARE_PLOTS - Plot comparison between different trading strategies
%
% Syntax:  compare_plots(results, outputPath)
%
% Inputs:
...
% Use annotation for title if suptitle is not available
try
    suptitle('Performance Metrics Comparison');
catch
    % Alternative for older MATLAB versions
    annotation('textbox', [0.5, 0.95, 0, 0], 'String', 'Performance Metrics Comparison', ...
