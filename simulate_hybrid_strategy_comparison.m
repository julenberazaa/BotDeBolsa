...
if exist('trainNetwork', 'file') ~= 2
    fprintf('ERROR: Deep Learning Toolbox NO está instalado.\n');
else
    fprintf('Deep Learning Toolbox está instalado correctamente.\n');
end
...
subplot(2, 2, 1);
plot(dateAxis(2:end), [macdTurnover; 0], 'b', 'LineWidth', 1.5);
hold on;
plot(dateAxis(2:end), [originalTurnover; 0], 'r', 'LineWidth', 1.5);
plot(dateAxis(2:end), [regularizedTurnover; 0], 'g', 'LineWidth', 1.5);
hold off;
...
subplot(2, 2, 2);
plot(dateAxis(2:end), [hybridOriginalTurnover; 0], 'm', 'LineWidth', 1.5);
hold on;
plot(dateAxis(2:end), [hybridRegularizedTurnover; 0], 'c', 'LineWidth', 1.5);
hold off;
